...
class Test {
  ...
  public static void main(String[] args) {
   ...
   System.out.println("Enter the First String :" );
    String first = sc.nextLine();// Taking First string input
   System.out.println("Enter the Second String :" );
    String second = sc.nextLine();//Taking Second String Input
    System.out,println("Enter no. of strings u want to check ");
    int n = sc.nextInt();// taking int input of the numbers of strings that has tobe checkd
    String[] results = new String[n];
    sc.nextLine();// TaKing Input of the newline or results will take its first input as newline
      // ommit it to see the error
    for(int i=0;i<n;i++){
        results[i] = sc.nextLine();// Taking the strings as input
